...
function GatewayService(options) {
    ...
    /**
     * Build payment link for simplified purchases
     *
     * @param {Object}   request
     * @param {Object}   response
     * @param {Function} callback
     */
    function buildPaymentLink(request, response, callback) {
        request.gatewayServlet = '/hostedpage/servlet/BuildPaymentLinkSubmit';
        performTransaction(request, response, function(results, request, response) {
            callback(results, request, response);
        });
    }
